# template completion script generated by https://github.com/adaszko/complgen v0.10.1-0-g9158856501
...
_template () {
    ...
    local -a literals=("--verbose" "--write" "--force" "--help" "-w" "-v" "-h" "-f")
    local -A literal_transitions=()
    literal_transitions[0]="([1]=1 [3]=0 [4]=1 [6]=0)"
    literal_transitions[1]="([2]=2 [7]=2)"
    literal_transitions[2]="([0]=0 [5]=0)"
    ...
    local -A literal_transitions_level_1=([0]="1 3 4 6" [1]="2 7" [2]="0 5")
